...
- `POST https://indodax.com/tapi/countdownCancelAll` (HMAC SHA512)
- `POST https://btcapi.net/tapi/countdownCancelAll` (HMAC SHA512)
...
```bash
curl --location -X POST 'https://d-idx.com/tapi/countdownCancelAll?pair=btc_idr%2Ceth_idr&countdownTime=10000&timestamp=1578304294001&recvWindow=1578303937000' \
...
```bash
curl --location -X POST 'https://d-idx.com/tapi/countdownCancelAll' \
--header 'Key: LSCE7NJG-JACRNTBX-D834R4UG-KMMTV8OP-PS1NHRBA' \
